...
{ "ER_QUERY_TIMEOUT", 999, "Query execution was interrupted, max_statement_time exceeded" },
...
{ "ER_BLOCK_MYISAM_TABLES", 1885, "Non-temporary MyISAM tables cannot be created outside mysql schema." },
{ "ER_CANNOT_CHANGE_SSL_VAR", 1886, "Cannot change the dynamic variable %s while ssl is ON. First turn off ssl using SET @@global.ssl=0." },
{ "ER_BLOCK_FTWRL", 1887, "Locking forms of FLUSH TABLES are blocked to avoid slave deadlocks." },
{ "ER_TMP_TABLE_MAX_FILE_SIZE_EXCEEDED", 1888, "Temporary table file is too big" },
{ "ER_QUERY_EXCEEDED_ROWS_EXAMINED_LIMIT", 1889, "Query execution was interrupted. The query examined at least %lu rows, which exceeds LIMIT ROWS EXAMINED (%lu). The query result may be incomplete." },
{ "ER_FAILED_TO_INSTANTIATE_TMP_TABLE", 1890, "Failed to instantiate temporary table." },
{ "ER_FAILED_TO_CREATE_TMP_TABLE_FROM_HEAP", 1891, "Failed to create temporary table from heap." },
{ "ER_READ_ONLY_SLAVE", 1892, "read_only should not be disabled on a slave. Slave with read_only=0 may generate new GTID on its own breaking replication or may cause a split brain. This error can be avoided by turning off the variable read_only_slave. Any session which writes to slaves must set sql_log_bin=0 to avoid GTID generation." },
{ "ER_INVALID_JSON", 1893, "Invalid JSON object: \'%.64s\'" },
{ "ER_INVALID_JSON_ARRAY", 1894, "Invalid JSON array: \'%.64s\'" },
{ "ER_INVALID_VALUE_FOR_DOCUMENT_FIELD", 1895, "Invalid document value: \'%.64s\' for column \'%.192s\' at row %ld" },
{ "ER_DOCUMENT_FIELD_IN_NON_INNODB_TABLE", 1896, "A DOCUMENT field is not allowed in non-innodb table" },
{ "ER_DOCUMENT_FIELD_IN_PART_FUNC_ERROR", 1897, "A DOCUMENT field is not allowed in partition function" },
{ "ER_DOCUMENT_KEY_NOT_SUPPORTED", 1898, "DOCUMENT column \'%-.192s\' cannot be part of a key" },
{ "ER_DOCUMENT_FIELD_NOT_ALLOWED", 1899, "DOCUMENT fields are not allowed" },
{ "ER_REQUESTED_PURGED_GTID", 1900, "The requested GTID is purged and so cannot be found in binary logs." },
{ "ER_REQUESTED_GTID_NOT_IN_EXECUTED_SET", 1901, "The requested GTID is not yet executed and so cannot be found in binary logs." },
{ "ER_SHOW_DENIED_ERROR", 1902, "You are not owner of thread %lu" },
